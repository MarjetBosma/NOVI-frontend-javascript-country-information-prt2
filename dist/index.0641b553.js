...
function createLanguageDescription(languages) {
    ...
    for(let i = 0; i < languages.length; i++){
        if (languages.length === 1) return output += languages[i].name; // Als er maar één entry is, alleen de taal toevoegen; return statement stopt de loop dan.
        if (i === languages.length - 1) return output += " and " + languages[i].name; // Bij laatste entry moet er "and" voor, return statement stopt de loop dan.
        if (languages.length === 2 || languages.length === 1 || i === languages.length - 2) output += languages[i].name // Alleen de taal toevoegen
        ;
        else output += languages[i].name + ", "; // Komma en spatie toevoegen
    }
    return output;
}
...
var Buffer = require("df7cf7bb06fa2490").Buffer;
"use strict";
/**
...
},{"df7cf7bb06fa2490":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("4feeed9c08799770");
var ieee754 = require("8adabf3702425036");
...
},{"4feeed9c08799770":"eIiSV","8adabf3702425036":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
